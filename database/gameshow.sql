...
--
-- Host: localhost:3306
-- Generation Time: Oct 03, 2025 at 10:25 AM
...
(66, 'Find which bell pip combo doesn\'t exist:', 'Blood Scourge: Throw, Size', 'Sacred Field: Sanity, Elemental, Physical Resistances', 'Teleportation: Cooldown, Speed, Waypoints', 'c', 0),
...
(85, 'How many Aces are awarded by completing Elykris\'s Ministry book quest at Minityrsa?', '3', '5', '6', 'a', 0),
...
(2, 'What\'s dawnwalkers\' talent which empowers your strikes with pure light?', 'luminous flash', 1),
(3, 'What level do you stop escaping the depths for free?', 'Power 3', 1),
(4, 'Which legendary weapon does NPC \"Volu\" unlock, by giving him three tomes?', 'Bloodfouler', 1),
(5, 'What was the name of the secret cave near summer isle, which now is gone?', 'The hidden grove', 1),
(6, 'What was the player for the original astral obtainment called?', 'The Wishmaker or Iltria', 1),
(7, 'What fighting style is supported by the \"Navaen War Chief\" schematic?', 'Way of Navae', 1),
(8, 'Which shrine let\'s you advance 3 powers?', 'Shrine of Blasphemy', 1),
(9, 'Which oath is obtained directly from Yun’Shul?', 'Soulbreaker', 1),
(10, 'Name a weapon which requires a dormant splinter, but not a razor cutlass.', 'Fondant Splitter or Sanguine Transfuser', 1),
(11, 'Frosviernr Joraelnaero gives you which weapon?', 'Kyrswynter', 1),
(12, 'Name a location in the etrean luminant \"The Den Master\" is located.', 'Etris, Isle of Vigils', 1),
(13, 'What is the exact location of the shadowcast trainer in the overworld called?', 'Derelict Highchurch', 1),
(14, 'What star mantra is metal fakeout?', '2', 1),
(15, 'Which race is based on a moth?', 'Chrysid', 1),
(16, 'What is the exact name for the area where you unlock union hook?', 'The Frontier Furnace', 1),
(17, 'Which stone knight variant has an extremely low chance to drop astral?', 'Moon Knight', 1),
(18, 'Which race is commonly depicted with Halos?', 'Lightborn', 1),
(19, 'What was the original obtainment method for Rhythm?', 'Ferryman', 1),
(20, 'Which (Spec) Enchant has the ability to proc every enchant on-hit?', 'Unstable', 1),
(21, 'Which obtainable legendary weapon was community made?', 'Light’s Final Toll', 1),
(22, 'Which NPC untarnishes your bell for 1 knowledge?', 'Dr. Carrion', 1),
(23, 'Which ministry prophet granted Chaser his blood powers?', 'The Second Prophet', 1),
(24, 'What is the Hivelord’s Hubris strength stat requirement?', '60', 1),
(25, 'Which weapon has a baseball swing looking critical?', 'Kanabo', 1),
(26, 'What attunement is layer three based on?', 'Flamecharm', 1),
(27, 'Who does Lord Regent wind up crucifying in the Duke quest?', 'Kennith', 1),
(29, 'Where else do the layer 2 winds appear in the game, outside of a dungeon?', 'Moon’s Eyrie', 1),
(30, 'What is the exact name for the place the dreadstar is located at?', 'Beloved Zofia', 1),
(31, 'What is the name of the starter dagger?', 'Stiletto', 1),
...
(35, 'Name one thing the \'vacant\' flaw does.', 'You cannot enter Castle Light nor can you partake in a Vow of Mastery.', 1),
(36, 'What flaw do you get when you reroll your Resonance?', 'Tarnished', 1),
...
(39, 'Which area’s description is “A place remembered only by the waves.”?', 'Boatman’s Watch', 1),
(41, 'What is the only echo modifier that gives 0.5x echoes?', 'Fragile Heart', 1),
(42, 'What oath gives the talent “Protagonist Syndrome”?', 'Dawnwalker', 1),
(43, 'What is considered the source of power for the Stormseye?', 'Kyrsan Medallions', 1),
(44, 'How much knowledge does Beiruul’s quest give?', '2', 1),
(45, 'What level is required to equip the Bloodforged Crown?', '15', 1),
(46, 'What area’s description is “What was stolen from below lies within.”?', 'Duke Erisia’s Manor', 1),
(47, 'What color is the Manor Key when not glowing?', 'Gray', 1),
(48, 'How many dying embers are required to gain the talent “Pleeksty’s Will”?', '3', 1),
(49, 'In what area is the NPC that removes your negative Hive reputation?', 'The Lordsgrove', 1),
(50, 'The Meteor Isle is territory of what faction?', 'Children of Navae', 1),
(51, 'What item is needed to light the flame pedestals in the Birdcage?', 'Soul Hearthgem', 1),
(52, 'What is the name of the Coral Fever assistant?', 'Destroyman III', 1),
(53, 'What building is the Flamecharm trainer located?', 'Songseeker Temple', 1),
(54, 'Is the \"Worshipper Longshield\" a real item?', 'No it\'s not', 1),
(55, 'What is the colour of The Ferryman\'s Lightning?', 'Purple', 1),
(56, 'What color of flame is seen in game but not as a part of (obtainable) weapons or mantras?', 'Purple', 1),
(57, 'Where is Korilfiend found? [lore]', 'The Vents / Layer Three', 1),
(58, 'What talent has the highest stat requirement?', 'Chorus of souls (210)', 1),
(59, 'Name the guild base room that has an Artisan in it.', 'Trophy Room', 1),
(60, 'What origin used to be a flaw?', 'Deepbound (Before 8/22/2022)', 1),
(61, 'What character says the line: “A rose, a cornflower, and perhaps a hyacinth appear to me in a dream.”?', 'Miserables', 1),
(62, 'Which mantra is unlocked from beating Duke Erisia?', 'Pillars of Erisia', 1),
(63, 'What is the name of the person who unbounds your fortitude?', 'Brutus', 1),
(64, 'Which stat is trained by getting \"spam grip cancelled\"?', 'Fortitude', 1),
(65, 'What is the weapon skin won by winning an artist competition?', 'The Paintbrush', 1),
(66, 'Who are the Hundred Legions investigating in the Etrean Luminant?', 'The Central Authority', 1),
(67, 'What is the name of the main island in the Central Luminant?', 'Markor', 1),
(68, 'What is the \"hero blade oath\" called?', 'Saintsworn', 1),
...
(72, 'What is the name of the NPC that gives you the Windwaker talent?', 'Stratos', 1),
(73, 'What is the exact name of the potion which unlocks shadowcast?', 'Nightblood', 1),
(74, 'What enemy is the only enemy that can attack you with a pickaxe?', '\"Mudskipper\" or \"Mineskipper\"', 1),
(75, 'How much knowledge does the Harrowing Enchant Stone cost?', '10 knowledge', 1),
(76, 'How much joy did the Halloween ‘22 Medal cost?', '200', 1),
(77, 'What enemy is the only enemy that can drop the Markor’s Inheritor directly?', 'Lost Divers (New kyrsa)', 1),
(78, 'What NPC says “If you value your life, you will run”?', 'Windrunner (Top of Etris wilds)', 1),
(80, 'Who corrupts the Kyrsgarde\'s minds in New Kyrsa?', 'Ethiron', 1),
(81, 'Who is a lightborn trapped in the outskirts of New Kyrsa?', 'Kaide', 1),
(82, 'What is the “snow” in Floor 1 made out of?', 'Parasites', 1),
(83, 'What group of people still believes in using the Song from the Old World?', 'Songseekers', 1),
(84, 'Name a frostdraw mantra that a round spark be used on.', 'Ice Eruption or Ice Carve', 1),
(85, 'What NPC says “Do you have the knowledge within you then, my dull friend?”?', 'Miserables', 1),
(86, 'What is the last echo talent to be unlocked?', 'Thresher Scales', 1),
(87, 'Name the element that will never be a Deepwoken Attunement.', 'Water', 1),
(88, 'What wisp grants passive tempo?', 'Shadow/Shade wisp', 1),
(90, 'Which triumph (accomplishment) gives the most echoes?', 'Obtaining a Resonance', 1),
(92, 'Aside from Akira & Ferryman, who is a seen character with a ring named after them?', 'Maestro Evengarde Rest', 1),
(93, 'The weapons unbound talents are in which talent category?', 'Saint of Blades', 1),
(95, 'What origin does bounties to progress', 'Voidwalker', 1),
(96, 'What is your depths trial at power 1, with diver origin?', 'Enforcer', 1),
(97, 'Next to sanity what stat does willpower also increase?', 'Tempo', 1),
(98, 'What Layer is New Kyrsa in?', 'two', 1),
(99, 'How much Thundercall does surge path require?', '40', 1),
(100, 'What talent allows Lord’s Slice to be used?', 'Hidden Tendril', 1),
(101, 'How many Sky Statues exist?', '3', 1),
(102, 'What is the name of the miniboss that drops the Deepspindle?', 'Ministry Cache Agent', 1),
(103, 'What enchant deals AoE damage on all weapon hits?', 'Wild', 1),
(104, 'What talent used to make blood run out faster when hitting people whilst downed?', 'Bloodletter', 1),
(105, 'Which type of mantra is lightning cloak?', 'Mobility', 1),
(106, 'What star mantra is Tornado?', '1 Star', 1),
(108, 'Name a weapon which has a 30 second cooldown on its critical.', 'First Light or Vortex Echo', 1),
(109, 'Which deep shrine has the ability to trade out one trait for another?', 'Shrine of Mastery', 1),
(110, 'The Pleeksty’s Inferno initially required how much Flamecharm?', '90', 1),
(111, 'All hero blades require how much attunement stat?', '75', 1),
(112, 'Which oath saves pathfinders from the depths?', 'Blindseer', 1),
(113, 'Name one talent needed to get Blindseer.', 'Breathing Exercise, Conquer your Fears and Disbelief', 1),
(114, 'What are the entities called that spot you and spawn angels on you?', 'Watchers', 1),
(115, 'What is the name of the event that lead to the start of Deepwoken? [lore]', 'The Tides', 1),
(116, 'What equipment piece do you need to have equipped to obtain blindseer?', 'A blindfold', 1),
(117, 'What is the second obtainment method for soulbreaker, involving a boss?', 'Using a sinner\'s ash in Duke\'s dungeon', 1),
(118, 'What is the talent reroll shrine called?', 'Shrine of Chance', 1),
(120, 'Which Prophet of the Ministry gave Chaser and his apprentices the power of Bloodrend?', 'The Second Prophet', 1),
(121, 'Finish this sentence: \"Vermin! You seek to let Celtor What?\"', 'Repeat / You seek to let Celtor repeat', 1),
(122, 'How many 0 star mantras does Flamecharm currently have?', '7', 1),
(123, 'Finish this sentence: \"This one\'s sanity must\'ve What?\"', 'Already Crumbled / This one\'s sanity must\'ve already crumbled', 1),
(124, 'What is the name of every island containing an NPC selling mantra modifiers?', 'Isle of Vigils, Miners Landing, Meteor Isle', 1),
(125, 'What single ingame item sells for the most notes without any selling modifiers?', 'Champion\'s Alloy', 1),
...
(128, 'What is the max amount of Kyrsan Medallions you can hold outside of Layer 2?', '250', 1),
(129, 'Which was the first of these Oath to get reworked? Was it either, Jetstriker, Silentheart, or Visionshaper?', 'Jetstriker', 1),
(130, 'True or False: Ironsing has no talents with mutual exclusives', 'False, the Rending Needle talents are exclusive with each other', 1),
(131, 'True or False: A fully charged Veinbreaker does enough damage to instantly guardbreak most builds.', 'False, rather then dealing higher posture, it instead fully bypasses block', 1),
(132, 'How many 3 star mantras does Frostdraw and Ironsing have combined?', '9', 1),
(133, 'True or False: There are no monster mantras in the Support category', 'False, Enforcer Pull', 1),
(134, 'Which of these is not a real talent? Is it either, Devastating Power, Vasculitis, Dispatch, or Haemostasis?', 'Haemostasis', 1),
(135, 'True or False: Visionshaper once had a Willpower requirement?', 'True', 1),
(136, 'Which oath has this oathbreak dialogue from Yun\'shul?: \"Was this not the future we sought? Perhaps not.\"', 'Bladeharper', 1),
(137, 'What was the name of Deepwokens first April Fools Event?', 'Mudwoken', 1),
(138, 'What is the name of Aelita\'s brother?', 'Tillian', 1),
(139, 'What\'s the crafting recipe for candles?', '1 Fiber, 1 Beeswax', 1),
(140, 'What 2 players have the spec \"Moon Blades\"?', 'Supaa and Valekis', 1),
(141, 'Where is the NPC Marcus found?', 'The Hidden Village', 1),
(142, 'How many notes does one item from the Meat Lord cost?', '2', 1),
(143, 'What stat is unbound at The Birdcage?', 'Intelligence', 1),
(144, 'Which advanced talent is unlocked from having all of the \"Immolator\" talents?', 'Phoenix Flames', 1),
(145, 'What color of Capra race gives the talent \"Mark of Jurik\"?', 'Blue', 1),
(146, 'Trigi is a last name of which race?', 'Vesperian', 1),
(147, '\"The 72 Seasons\" is a location from what event?', 'The Metallica crossover event', 1),
(148, 'Gold bars can be crafted at a campfire utilizing what item?', 'Gold Rings', 1),
(149, 'Drakkards can passively train their stats through the use of what talent?', 'Teachings of the Edenkite', 1),
(150, 'The \"Aazel\'s Horns\" head accessory are a reference to what game?', 'Rogue Lineage', 1),
(151, 'The Teleportation Resonance was once often referred to by what community-given name?', 'Flying Raijin / Gate / Fast Travel', 1),
(152, '\"Conjure a protective energy that will guide those fallen in battle towards you.\" is a description belonging to what ability?', 'Preservation', 1),
(153, '\"The conditions have been fulfilled, they are to leave unscathed.\" is said by which voice of the Depths Trials?', 'Voice of Authority', 1),
(154, 'What is the name of the winning weapon from the 2023 Weapon Art Concept competition, still yet to be added?', 'Bloodsworn Effigy', 1),
(155, 'The family controlling The Floating Keep go by what name?', 'Spellhardt / Spellhardt Family', 1);
